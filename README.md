...
## Update
We incorporate scripts for leveraging the [Meta-Llama-3-8B-Instruct](https://huggingface.co/meta-llama/Meta-Llama-3-8B-Instruct) model to conduct experiments on the [gsm8k](https://huggingface.co/datasets/gsm8k) and [magicoder](https://huggingface.co/datasets/ise-uiuc/Magicoder-OSS-Instruct-75K) datasets. If interested, you may try [scripts/gsm8k/sdft_llama3.sh](scripts/gsm8k/sdft_llama3.sh).
